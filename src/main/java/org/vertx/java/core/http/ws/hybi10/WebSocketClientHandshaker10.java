 ...
 * under the License.
 */
package org.vertx.java.core.http.ws.hybi10;

import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.CONNECTION;
import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.HOST;
import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.UPGRADE;
import static org.vertx.java.core.http.HttpServer.Names.SEC_WEBSOCKET_ACCEPT;
import static org.vertx.java.core.http.HttpServer.Names.SEC_WEBSOCKET_KEY;
import static org.vertx.java.core.http.HttpServer.Names.SEC_WEBSOCKET_VERSION;
...
import org.vertx.java.core.http.ws.WebSocketHandshakeException;
...
public class WebSocketClientHandshaker10 extends WebSocketClientHandshaker {
     ...
     * @throws Exception
     */
    public void generateRequest(final HttpClientRequest req, final String hostHeader) throws Exception {
		req.putHeader(SEC_WEBSOCKET_VERSION, "8");
		req.putHeader(CONNECTION, "Upgrade");
		req.putHeader(UPGRADE, "WebSocket");
		req.putHeader(HOST, hostHeader);
		req.putHeader(SEC_WEBSOCKET_KEY, getWebSocketChallenge().getNonceBase64());
	}
