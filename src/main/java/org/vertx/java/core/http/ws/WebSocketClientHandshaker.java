...
public abstract class WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker(URI webSocketURL, WebSocketSpecificationVersion version, String subProtocol) {
        ...
        try {
			...
			throw new InternalError("Algorithm not supported on this platform");
		}
    }
    ...
    protected WebSocketChallenge getWebSocketChallenge() {
    	return challenge;
    }
    ...
    /**
     * Assigns the correct parameters for request.
     * 
     * @param req
     * 			Request object
     * @param hostHeader
